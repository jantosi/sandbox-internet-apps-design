...
public class TransitResource {
    ...
    @Timed
    public ResponseEntity<Transit> createTransit(@RequestBody Transit transit) throws URISyntaxException {
    ...
    @RequestMapping(value = "/transits",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Transit> updateTransit(@RequestBody Transit transit) throws URISyntaxException {
    ...
    public List<Transit> getAllTransits() {
        log.debug("REST request to get all Transits");
