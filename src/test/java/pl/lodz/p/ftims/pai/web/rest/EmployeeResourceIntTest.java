...
public class EmployeeResourceIntTest {
    ...
    private static final String DEFAULT_MOBILE_PHONE_NO = "AAAAA";
    private static final String UPDATED_MOBILE_PHONE_NO = "BBBBB";
    ...
    public void initTest() {
        ...
        employee.setMobilePhoneNo(DEFAULT_MOBILE_PHONE_NO);
    }
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getMobilePhoneNo()).isEqualTo(DEFAULT_MOBILE_PHONE_NO);
    }
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees"))
                ...
                .andExpect(jsonPath("$.[*].mobilePhoneNo").value(hasItem(DEFAULT_MOBILE_PHONE_NO.toString())));
    }
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.mobilePhoneNo").value(DEFAULT_MOBILE_PHONE_NO.toString()));
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        employee.setMobilePhoneNo(UPDATED_MOBILE_PHONE_NO);
        ...
        assertThat(testEmployee.getMobilePhoneNo()).isEqualTo(UPDATED_MOBILE_PHONE_NO);
    }
