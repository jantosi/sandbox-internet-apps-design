...
private static final TransitType DEFAULT_TYPE = TransitType.NORMAL;
    private static final TransitType UPDATED_TYPE = TransitType.EXPRESS;


private static final TransitStatus DEFAULT_STATUS = TransitStatus.CREATED;
    private static final TransitStatus UPDATED_STATUS = TransitStatus.ACCEPTED;
    ...
    public void initTest() {
        ...
        transit.setStatus(DEFAULT_STATUS);
    ...
    public void createTransit() throws Exception {
        ...
        assertThat(testTransit.getStatus()).isEqualTo(DEFAULT_STATUS);
    ...
    public void checkTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = transitRepository.findAll().size();
        // set the field null
        transit.setType(null);

        // Create the Transit, which fails.
        ...
        List<Transit> transits = transitRepository.findAll();
        assertThat(transits).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateTransit() throws Exception {
        ...
        transit.setStatus(UPDATED_STATUS);
        ...
        assertThat(testTransit.getStatus()).isEqualTo(UPDATED_STATUS);
