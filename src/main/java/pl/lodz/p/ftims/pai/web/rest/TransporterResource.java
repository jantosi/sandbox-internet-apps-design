...
public class TransporterResource {
    ...
    @Timed
    public ResponseEntity<Transporter> createTransporter(@Valid @RequestBody Transporter transporter) throws URISyntaxException {
    ...
    @RequestMapping(value = "/transporters",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Transporter> updateTransporter(@Valid @RequestBody Transporter transporter) throws URISyntaxException {
    ...
    @RequestMapping(value = "/transporters",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Transporter>> getAllTransporters(Pageable pageable)
        throws URISyntaxException {
        Page<Transporter> page = transporterRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/transporters");
